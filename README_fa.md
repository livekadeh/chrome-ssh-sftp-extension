...
1. فایل زیپ افزونه [`chrome-ssh-sftp-extension-v1.1.0.zip`](https://github.com/livekadeh/chrome-ssh-sftp-extension/releases/download/v1.1.0/chrome-ssh-sftp-extension-v1.1.0.zip) را دانلود و استخراج (Extract) کنید.
