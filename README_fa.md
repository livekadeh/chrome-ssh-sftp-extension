...
[![Release v1.5.1](https://img.shields.io/badge/Release-v1.5.1-orange?style=for-the-badge)](https://github.com/livekadeh/chrome-ssh-sftp-extension/releases/tag/v1.5.1)
...
1. فایل زیپ افزونه [`livekadeh-ssh-sftp-extension-v1.5.1.zip`](https://github.com/livekadeh/chrome-ssh-sftp-extension/releases/download/v1.5.1/livekadeh-ssh-sftp-extension-v1.5.1.zip) را دانلود و استخراج (Extract) کنید.
