...
[![Release v1.5.0](https://img.shields.io/badge/Release-v1.5.0-orange?style=for-the-badge)](https://github.com/livekadeh/chrome-ssh-sftp-extension/releases/tag/v1.5.0)
...
1. فایل زیپ افزونه [`livekadeh-ssh-sftp-extension-v1.5.0.zip`](https://github.com/livekadeh/chrome-ssh-sftp-extension/releases/download/v1.5.0/livekadeh-ssh-sftp-extension-v1.5.0.zip) را دانلود و استخراج (Extract) کنید.
