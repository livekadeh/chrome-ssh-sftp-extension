...
const I18N_DICTIONARY = {
  en: {
    ...
    sftp_extract_btn: 'Extract Archive',
    sftp_copy_btn: 'Copy (Ctrl+C)',
    sftp_cut_btn: 'Cut / Move (Ctrl+X)',
    sftp_paste_btn: 'Paste (Ctrl+V)',
    sftp_move_btn: 'Move To...',
    sftp_ctx_copy: 'Copy',
    sftp_ctx_cut: 'Cut',
    sftp_ctx_paste: 'Paste',
    sftp_ctx_move_to: 'Move To...',
    sftp_ctx_rename: 'Rename',
    sftp_ctx_chmod: 'Permissions (Chmod)',
    sftp_ctx_delete: 'Delete',
    sftp_delete_btn: 'Delete Selected',
    sftp_delete_all_btn: 'Delete All',
    ...
    sftp_compress_btn: 'Compress Files',
    sftp_ctx_compress: 'Compress (Zip / Tar)',
    sftp_preview_btn: 'Preview / Play Media',
    sftp_ctx_preview: 'Preview / Play Media',
    sftp_open_with_btn: 'Open With External Application...',
    sftp_ctx_open_with: 'Open With...',
    editor_open_with: 'Open With...',
    openwith_modal_title: 'Open With...',
    openwith_sec_system: 'System External Editor (Auto-Sync)',
    openwith_app_default: 'System Default App',
    openwith_app_default_desc: 'xdg-open / Windows Default',
    openwith_app_custom: 'Custom Executable / Command',
    openwith_app_custom_desc: 'Custom CLI or App Path',
    openwith_custom_label: 'Command or Path to Executable:',
    openwith_autosync_lbl: 'Auto-sync changes to remote server on save (Ctrl+S) ⚡',
    openwith_autosync_hint: 'The bridge watches the local file and automatically uploads modified contents whenever you save.',
    openwith_launch_btn: '🚀 Open in Selected System App',
    openwith_sec_browser: 'Browser View & Web Editor',
    openwith_new_tab: 'Open in New Tab',
    openwith_new_tab_desc: 'View code, raw text, or media in a browser tab',
    openwith_builtin: 'Built-in Editor',
    openwith_builtin_desc: 'Edit directly inside LiveKadeh extension',
    openwith_save_picker: 'Save & Sync Local File',
    openwith_save_picker_desc: 'Save to disk via Chrome File Picker & sync',
    settings_ext_editor_title: 'External Editor (Open With)',
    settings_ext_editor_hint: 'Configure the default external desktop application to open SFTP files:',
    settings_ext_editor_label: 'Default External Editor:',
    settings_ext_editor_custom: 'Custom Command / Path:',
    settings_ext_autosync: 'Automatically upload changes on save (Ctrl+S)',
    sftp_ctx_info: 'Information',
    sftp_ctx_dir_info: 'Folder Information',
    ...
    // Information Modal
    info_modal_title: 'Folder & File Information',
    info_lbl_name: 'Name:',
    info_lbl_type: 'Type:',
    info_lbl_path: 'Full Path:',
    info_lbl_size: 'Total Size:',
    info_lbl_contains: 'Contains:',
    info_lbl_permissions: 'Permissions:',
    info_lbl_owner: 'Owner / Group:',
    info_lbl_modified: 'Last Modified:',
    info_calculating: 'Calculating size...',
    info_type_dir: 'Folder (Directory)',
    info_type_file: 'File',
    info_items_count: '{files} files, {dirs} folders',
  ...
  fa: {
    ...
    sftp_parent_dir: 'یک سطح بالاتر (پوشه والد)',
    sftp_refresh: 'بارگذاری مجدد پوشه',
    sftp_go_btn: 'رفتن به مسیر',
    ...
    sftp_extract_btn: 'استخراج فایل فشرده',
    sftp_copy_btn: 'کپی (Ctrl+C)',
    sftp_cut_btn: 'برش و انتقال (Ctrl+X)',
    sftp_paste_btn: 'جای‌گذاری / پیست (Ctrl+V)',
    sftp_move_btn: 'انتقال به...',
    sftp_ctx_copy: 'کپی',
    sftp_ctx_cut: 'برش (Cut)',
    sftp_ctx_paste: 'جای‌گذاری (Paste)',
    sftp_ctx_move_to: 'انتقال به...',
    sftp_ctx_rename: 'تغییر نام',
    sftp_ctx_chmod: 'تغییر سطح دسترسی (Chmod)',
    sftp_ctx_copy_path: 'کپی مسیر کامل',
    sftp_ctx_delete: 'حذف',
    sftp_delete_btn: 'حذف موارد انتخاب‌شده',
    sftp_delete_all_btn: 'حذف همه موارد انتخاب‌شده',
    ...
    sftp_compress_btn: 'فشرده‌سازی فایل‌ها (Zip / Tar)',
    sftp_ctx_compress: 'فشرده‌سازی فایل‌ها (Compress)',
    sftp_preview_btn: 'پیش‌نمایش یا پخش مدیا',
    sftp_ctx_preview: 'پخش و نمایش مدیا (Preview)',
    sftp_open_with_btn: 'باز کردن با برنامه خارجی...',
    sftp_ctx_open_with: 'باز کردن با...',
    editor_open_with: 'باز کردن با...',
    openwith_modal_title: 'باز کردن با... (Open With)',
    openwith_sec_system: 'ویرایشگر خارجی سیستم (همگام‌سازی خودکار)',
    openwith_app_default: 'برنامه پیش‌فرض سیستم',
    openwith_app_default_desc: 'برنامه پیش‌فرض ویندوز یا لینوکس',
    openwith_app_custom: 'دستور یا مسیر سفارشی',
    openwith_app_custom_desc: 'مسیر فایل اجرایی یا دستور دلخواه',
    openwith_custom_label: 'دستور یا آدرس کامل برنامه:',
    openwith_autosync_lbl: 'همگام‌سازی خودکار تغییرات در سرور پس از ذخیره (Ctrl+S) ⚡',
    openwith_autosync_hint: 'بریدج فایل را در سیستم تحت نظر می‌گیرد و با هر بار ذخیره، تغییرات را فوراً در سرور آپلود می‌کند.',
    openwith_launch_btn: '🚀 باز کردن در برنامه سیستم',
    openwith_sec_browser: 'نمایش و ویرایش در مرورگر',
    openwith_new_tab: 'نمایش در برگه جدید مرورگر',
    openwith_new_tab_desc: 'مشاهده کد، متن خام، عکس یا مدیا در یک برگه اختصاصی',
    openwith_builtin: 'ویرایشگر داخلی برنامه',
    openwith_builtin_desc: 'ویرایش سریع درون افزونه',
    openwith_save_picker: 'ذخیره در سیستم با پنجره فایل',
    openwith_save_picker_desc: 'ذخیره فایل در دیسک و همگام‌سازی دستی',
    settings_ext_editor_title: 'ویرایشگر خارجی (Open With)',
    settings_ext_editor_hint: 'برنامه دسکتاپ پیش‌فرض برای باز کردن و ویرایش فایل‌های SFTP:',
    settings_ext_editor_label: 'ویرایشگر پیش‌فرض سیستم:',
    settings_ext_editor_custom: 'دستور یا مسیر دلخواه برنامه:',
    settings_ext_autosync: 'آپلود خودکار تغییرات به محض ذخیره (Ctrl+S)',
    sftp_ctx_info: 'اطلاعات و مشخصات',
    sftp_ctx_dir_info: 'مشخصات این پوشه',
    ...
    // Information Modal
    info_modal_title: 'اطلاعات و مشخصات پوشه / فایل',
    info_lbl_name: 'نام:',
    info_lbl_type: 'نوع:',
    info_lbl_path: 'مسیر کامل:',
    info_lbl_size: 'حجم کل:',
    info_lbl_contains: 'محتویات:',
    info_lbl_permissions: 'سطح دسترسی:',
    info_lbl_owner: 'مالک / گروه:',
    info_lbl_modified: 'آخرین ویرایش:',
    info_calculating: 'در حال محاسبه اندازه...',
    info_type_dir: 'پوشه (Directory)',
    info_type_file: 'فایل (File)',
    info_items_count: '{files} فایل، {dirs} پوشه',
    info_copy_path: 'کپی مسیر',
    info_path_copied: 'مسیر کپی شد!',
    info_btn_close: 'بستن',
