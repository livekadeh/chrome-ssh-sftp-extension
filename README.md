...
1. Download [`livekadeh-ssh-sftp-extension-v1.5.1.zip`](https://github.com/livekadeh/chrome-ssh-sftp-extension/releases/download/v1.5.1/livekadeh-ssh-sftp-extension-v1.5.1.zip) from the latest release.
