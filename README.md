...
1. Download [`livekadeh-ssh-sftp-extension-v1.4.2.zip`](https://github.com/livekadeh/chrome-ssh-sftp-extension/releases/download/v1.4.2/livekadeh-ssh-sftp-extension-v1.4.2.zip) from the latest release.
