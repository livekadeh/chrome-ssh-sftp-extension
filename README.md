...
1. Download [`livekadeh-ssh-sftp-extension-v1.4.3.zip`](https://github.com/livekadeh/chrome-ssh-sftp-extension/releases/download/v1.4.3/livekadeh-ssh-sftp-extension-v1.4.3.zip) from the latest release.
