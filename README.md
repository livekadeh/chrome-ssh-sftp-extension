...
1. Download [`livekadeh-ssh-sftp-extension-v1.5.0.zip`](https://github.com/livekadeh/chrome-ssh-sftp-extension/releases/download/v1.5.0/livekadeh-ssh-sftp-extension-v1.5.0.zip) from the latest release.
